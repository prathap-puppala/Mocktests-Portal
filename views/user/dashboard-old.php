...
<div role="tabpanel" style="border:1px solid #399BFF;padding:0px;height:398px;margin:0px;">
              <!-- Nav tabs -->
                  ...
                  <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="exa">
               <center><a href="upload" target="_blank" style="font-size:18px;text-decoration:underline;color:red;">Upload Your own Question Paper</a></center>
...
$c=1;
	...
	mysql_select_db($dbname,$con);
	$result=mysql_query("SELECT * FROM examdetails WHERE visibility='1' and eid='NULL' ORDER BY sno DESC");
	$count=0;
...
<div class="test"> <div id='mat'></div> <br/>
    ...
    <!-- Start Inbox -->
    <div class="col-md-12 col-lg-3" style="height:315px;">
      
<div role="tabpanel" style="border:1px solid #399BFF;padding:0px;margin:0px;">
              <!-- Nav tabs -->
                  <ul class="nav nav-tabs tabcolor5-bg" role="tablist">
                    <li role="presentation" id='notifitab'><a href="#notifi" aria-controls="notifi" role="tab" data-toggle="tab">Notifications<?php 
          mysql_select_db($dbname,$con);
           if($g>0){?><span class="label label-danger"><?php echo $g;?></span><?php } ?></a></a></li>
                 
                    <li role="presentation"   class="active" id='acctab'><a href="#acc" aria-controls="acc" role="tab" data-toggle="tab">Toppers</a></li>
                  ...
                  <div class="tab-content">
                    <div role="tabpanel" class="tab-pane" id="notifi">
                      <div id="notificationarea" style="visibility:visible;height:315px;border:1px solid #399BFF;overflow-y:scroll;" title='Notifications'>
                      <marquee id="notifications"  bgcolor="#fff" scrolldelay="100" onmouseover="this.setAttribute('scrollamount', 0, 0);" onmouseout="this.setAttribute('scrollamount', 3, 0);" direction="up" scrolldelay="100" scrollamount="3"  behavior="alternate" hspace="10%" direction="up" speed="1" style="height:315px;">
                    ...
                    <div role="tabpanel" class="tab-pane  active" id="acc"  style="padding:0px;visibility:visible;border:1px solid #399BFF;height:315px;overflow-y:scroll;">
                     <!--acc-->
                     <marquee  bgcolor="#fff" scrolldelay="100" onmouseover="this.setAttribute('scrollamount', 0, 0);" onmouseout="this.setAttribute('scrollamount', 3, 0);" direction="up" scrolldelay="100" scrollamount="3"  behavior="alternate" hspace="10%" direction="up" speed="1" style="height:315px;">
                     <table class="table" width="100%">
                     <?php
                     mysql_select_db("quiz",$con);
                     $sss=mysql_query("SELECT * FROM examdetails WHERE visibility='1' and displayinprofile='1' ORDER BY sno DESC");
                     while($rr=mysql_fetch_array($sss))
                     {
                     $tab=$rr['tkey'];
                     echo "<tr><td colspan='3' class=\"success\"><font size='4px' weight='bold'>".$rr['title']."</font> Toppers</td></tr>";
                       mysql_select_db("quiz_exams",$con);
                     ...
                     if(mysql_num_rows($tt)<1){echo "<tr><td style='height:20px;' colspan='3'>No one has submitted</td></tr>";}
                     else{
                     ...
                     $stud=$rry['year']."-".$rry['branch']."-".$rry['class'];
                     mysql_select_db("quiz_exams",$con);
                     echo "<tr><td style='height:20px;'>".$ty['ID']."</td><td style='height:20px;'>".$stud."</td><td style='height:20px;font-weight:bold;font-size:16px;'>".$ty['marks']."</td></tr>";
                     }
                     }
                     }
                       mysql_select_db("quiz",$con);
...
<div role="tabpanel" style="border:1px solid #399BFF;padding:0px;margin:0px;">
                  <ul class="nav nav-tabs tabcolor5-bg" role="tablist">
                    <li role="presentation" class="active" id="uinfotab"><a href="#uinfo" aria-controls="uinfo" role="tab" data-toggle="tab">OS & Browser</a></li>
                    <li role="presentation" id="visistab"><a href="#visis" aria-controls="visis" role="tab" data-toggle="tab">Visits</a></li>
                 <li role="presentation" id="infotab"><a href="#info" aria-controls="info" role="tab" data-toggle="tab">Account</a></li>
                    </ul>

                  <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="uinfo">
						<table class="table" width="100%">
                     <tr><td class="info">OS</td><td class="success" style="font-weight:bold;"><mark><?php echo pla("os");?></mark></td></tr>
                     <tr><td class="warning">Browser</td><td class="active" style="font-weight:bold;"><mark><?php echo pla("browser");?></mark></td></tr>
                     </table>
                     
						</div>
                    <div role="tabpanel" class="tab-pane" id="visis">
                      <center><div class="clock" style="margin:2em;text-align:center;"></div></center>
                      </div>
                    ...
                    <div role="tabpanel" class="tab-pane" id="info">
						<center>
							...
							if($teckzitemode==false)
							{?>
							<a title="Edit Profile" name="views/user/editprofile.php" onclick="load_page(this.name)" class="btn btn-info">Edit profile</a>
							<br><a title="Edit Profile" name="views/user/changepaswd.php" onclick="load_page(this.name)" class="btn btn-success">Change Password</a>
							<?php } ?><br><a href="views/logout" class="btn btn-danger">Logout</a>
							</center>
						</div>
</div>
-->
...
<script type="text/javascript" src="myown/js/html5shiv.js"></script>
