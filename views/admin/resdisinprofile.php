...
?>
  ...
  <div class="page-header">
    <h1 class="title">Set Results to be Displayed in profile</h1>
      <ol class="breadcrumb">
        <li><a href="index">Results</a></li>
        <li class="active">Set Results to be Displayed in profile</li>
      </ol>
                ...
                <table class="table table-bordered">
                  ...
                  <div class="col-sm-10" >
                    <div class="radio radio-info radio-inline">
                        <input type="radio" id="inlineRadio1" value="option1" name="radioInline" onclick="shwfor('setdisofgivenow')">
                        <label for="inlineRadio1">Give Now</label>
                    </div>
                    <div class="radio radio-info radio-inline">
                        <input type="radio" id="inlineRadio2" value="option2" name="radioInline" onclick="shwfor('setdisofafteronline')">
