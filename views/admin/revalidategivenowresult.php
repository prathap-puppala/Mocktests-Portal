...
{
$mode="answersgivenow";
$allowed=array("answersgivenow");
if(in_array($mode,$allowed))
{
$viewn="Answers give Now";
   ...
   <table  width="100%" style="text-align:justify;" class="table table-bordered table-striped">
	...
	echo $startt;
                ...
                <td><?php mysql_select_db("quiz_exams",$con); echo mysql_num_rows(mysql_query("SELECT * FROM $tab WHERE status='Y'"));?></td>
                      ...
                      <a class="btn btn-success" style='cursor:pointer;'  onclick=validateexam("<?php echo $w['answers'];?>","<?php echo $w['sno'];?>","<?php echo $w['questions'];?>")><i class="fa fa-check-square-o"></i>Validate</a>
      <span id='loader'></span>
                   </td>
    ...
    <script>
    function validateexam(realans,sno,ques)
{
