...
$allowed=array("answersgivenow","answersafterexamonline");
if(in_array($mode,$allowed))
{
$viewn=($mode=="answersgivenow")?"Answers Give Now":"Answers After Exam Online";

?>
  <!-- Start Page Header -->
  <div class="page-header">
    <h1 class="title"><b style='color:red;'><?php echo $viewn."</b> Mode Results view";?></h1>
      <ol class="breadcrumb">
...
<div class="row">
   ...
   <table  width="100%" style="text-align:justify;" class="table table-bordered table-striped">
                <tbody>
					<tr><th colspan='2'><center>Answers <b style='color:red;'><?php echo $viewn;?> </b> mode</center></th></tr>
			</tbody>
			</table>
	...
	echo $startt;
                ...
                <td><?php mysql_select_db("quiz_exams",$con); echo mysql_num_rows(mysql_query("SELECT * FROM $tab WHERE status='Y'"));?></td>
                       ...
                       <td>
     <a class="btn btn-primary" style='cursor:pointer;' name="logic/php/admin/viewresult?sno=<?php echo $w['sno'];?>" onclick="load_page(this.name)"><i class="fa fa-bar-chart"></i>View</a>
