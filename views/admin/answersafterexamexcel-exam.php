...
$script="CREATE TABLE $number 
    ...
    {
mysql_select_db($dbname,$con);
if(mysql_query("INSERT INTO examdetails(eid,tkey,title,filename,filetype,date,startandendtimelimit,display,endat,countdown,type,options,questions,ccone,cwone,answersmode,answers,addedip,displayinprofile)
               VALUES('$eid','$number','$examtitle','$newf','$ext','$examdate','$startandendlimit','$ExamStartt','$EndExamt','$countdown','$type','$options','$questions','$ccone','$cwone','answersafterexamexcel','$realans','$ip','1')") or die(mysql_error()))		
	{
