...
<div class="row">
   ...
   <table  width="100%" style="text-align:justify;" class="table table-bordered table-striped">
	...
	{
		?>
	<a class="btn btn-success" style='cursor:pointer;' name="views/admin/validateexam.php?valida=validat&sno=<?php echo $w['sno'];?>" onclick="load_page(this.name)"><i class="fa fa-check-square-o"></i>Validate</a>
