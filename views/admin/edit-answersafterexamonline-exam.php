...
if(mysql_query("UPDATE examdetails SET eid='$eid',tkey='$number',title='$examtitle',filename='$newf',countdown='$countdown',ccone='$ccone',cwone='$cwone',filetype='$ext',date='$examdate',display='$ExamStartt',endat='$EndExamt',type='$type',options='$options',questions='$questions',ccone='$ccone',cwone='$cwone',addedip='$ip' WHERE sno='$sno'") or die(mysql_error()))		
	{
...
$prathap=mysql_query("SELECT * FROM examdetails WHERE sno='$sno'  and answersmode='answersafterexamonline'");
