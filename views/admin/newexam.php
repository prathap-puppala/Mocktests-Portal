                ...
                <table class="table table-bordered">
                  ...
                  <div class="col-sm-10" >
                    <div class="radio radio-info radio-inline">
                        <input type="radio" id="inlineRadio1" value="option1" name="radioInline" onclick="shwf('answersgivenow')">
                        <label for="inlineRadio1">Give Now</label>
                    </div>
                    <div class="radio radio-info radio-inline">
                        <input type="radio" id="inlineRadio2" value="option2" name="radioInline" onclick="shwf('answersafterexamonline')">
                        <label for="inlineRadio2">After exam(Online)</label>
                    </div>
                    
                    <div class="radio radio-info radio-inline">
                        <input type="radio" id="inlineRadio3" value="option3" name="radioInline" onclick="shwf('answersafterexamexcel')">
