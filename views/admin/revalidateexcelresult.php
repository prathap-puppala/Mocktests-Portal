...
?>
  ...
  <div class="page-header">
    <h1 class="title"><b style='color:red;'><?php echo $viewn."</b> Mode Results Re-Validation view";?></h1>
      <ol class="breadcrumb">
...
<div class="row">
   ...
   <table  width="100%" style="text-align:justify;" class="table table-bordered table-striped">
                <tbody>
					<tr><th colspan='2'><center>Answers <b style='color:red;'><?php echo $viewn;?> </b> Re-Validation mode</center></th></tr>
			</tbody>
			</table>
	...
	{
		?>
	<a class="btn btn-success" style='cursor:pointer;' href="logic/php/admin/validateexam.php?sno=<?php echo $w['sno'];?>" onclick="load_page(this.name)"><i class="fa fa-check-square-o"></i>Validate</a>
