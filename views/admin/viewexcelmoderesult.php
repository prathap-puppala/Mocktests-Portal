...
?>
  ...
  <div class="page-header">
    <h1 class="title"><b style='color:red;'><?php echo 'Answers After Exam Excel '."</b> Mode Results view";?></h1>
      <ol class="breadcrumb">
...
<div class="row">
   ...
   <table  width="100%" style="text-align:justify;" class="table table-bordered table-striped">
            ...
            <table id="example" class="table display">
				...
				if($teckzitemode)
				{
				$q=mysql_query("SELECT * FROM examdetails WHERE eid!='NULL' and visibility='1' and answersmode='answersafterexamexcel' and validations>0");
			    }
			    else
			    {
				$q=mysql_query("SELECT * FROM examdetails WHERE eid='NULL' and visibility='1' and answersmode='answersafterexamexcel' and validations>0");
	...
	echo $startt;
                ...
                <td><?php mysql_select_db("quiz_exams",$con); echo mysql_num_rows(mysql_query("SELECT * FROM $tab WHERE status='Y'"));?></td>
                       ...
                       <td>
     <a class="btn btn-primary" style='cursor:pointer;' name="logic/php/admin/viewresultexcelmode?sno=<?php echo $w['sno'];?>" onclick="load_page(this.name)"><i class="fa fa-bar-chart"></i>View</a>
